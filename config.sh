...
export COIN_GITHUB="https://github.com/ScryptChangeCoin/ScryptChange"
export URL_WEBSITE="http://scryptchange.com"
export FROM_YEAR="2018"
export TO_YEAR="2019"
export COIN_DOMAIN="scryptchange.com"

export COIN_NAME="ScryptChange"
export COIN_UNIT="XSCC"
...
export PHRASE="ScryptChange 25/Feb/2018 THE DOG HAS MANGE WATCH OUT SCRYPTCHANGE"
export MAINNET_PORT="37007"
export TESTNET_PORT="37006"
